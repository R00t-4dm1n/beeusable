...
const  ProductEditScreen = ({match, history})  => {
    ...
    return (
        <>
            <Link to='/user/productlist' className='btn btn-light my-3'>
                Go Back
            </Link>
           ...
           <Form.Group className='py-2' controlId = 'name'>
              ...
              <label htmlFor="upload-button">
                ...
                <>
                  ...
                  <i className="fas fa-file-upload fa-stack-1x fa-inverse" />
                  </span>
                  <h5>Upload Product  photo</h5>
                </>)}
              </label>
              <input type="file" id="upload-button" style={{ display: 'none' }} onChange={uploadFileHandler} />
              <br />
